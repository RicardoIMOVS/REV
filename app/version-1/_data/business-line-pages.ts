...
export const businessLinePages = {
  ...
  "marca-blanca": {
    ...
    audience: [
      ...
      "Nutriólogos",
      "Farmacias",
      "Empresas que buscan ampliar su portafolio",
      "Marcas consolidadas",
    ],
    benefits: [
      {
  ...
  base: {
    ...
    audience: [
      ...
      "Personas con rutinas activas",
      "Compradores wellness",
      "Clientes que buscan nutrición práctica",
      "Comunidades de bienestar",
      "Aliados comerciales B2C",
    ],
    benefits: [
      {
        title: "Marca propia",
      ...
      },
      {
        ...
        copy: "La página comunica una filosofía de volver a lo básico para construir hábitos que perduren.",
      },
      {
        title: "Compra futura",
    ...
    catalog: [
      ...
      {
        category: "Portafolio visual",
        description:
          "Espacio para fotografías de producto, beneficios, categorías y recomendaciones de uso.",
      },
      {
        category: "Contenido educativo",
        description:
          "Artículos, guías y recursos que conectan la marca con una experiencia de bienestar diario.",
      },
    ],
